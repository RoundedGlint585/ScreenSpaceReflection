...
#error Must include imgui_lib.h before imgui_internal.h
#endif
...
// This is going to be exposed in imgui_lib.h when stabilized enough.
enum ImGuiItemFlags_ {
    ...
    ImGuiItemFlags_Disabled = 1
            << 2,  // false    // [BETA] Disable interactions but doesn't affect visuals yet. See github.com/ocornut/imgui_lib/issues/211
...
// Windows data saved in imgui_lib.ini file
...
struct IMGUI_API ImGuiWindow {
    ...
    short BeginOrderWithinContext;            // Order within entire imgui_lib context. This is mostly used for debugging submission order related issues.
...
namespace ImGui {
    ...
    IMGUI_API bool
    DragBehaviorT(ImGuiDataType data_type, T *v, float v_speed, T v_min, T v_max, const char *format, float power,
    ...
    IMGUI_API bool
    TempInputTextScalar(const ImRect &bb, ImGuiID id, const char *label, ImGuiDataType data_type, void *data_ptr,
                        const char *format);
