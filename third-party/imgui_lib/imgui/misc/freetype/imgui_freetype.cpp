...
// - v0.52: (2017/09/26) fixes for imgui_lib internal changes.
// - v0.53: (2017/10/22) minor inconsequential change to match change in master (removed an unnecessary statement).
// - v0.54: (2018/01/22) fix for addition of ImFontAtlas::TexUvscale member.
// - v0.55: (2018/02/04) moved to main imgui_lib repository (away from http://www.github.com/ocornut/imgui_club)
...
// - v0.61: (2019/01/15) added support for imgui_lib allocators + added FreeType only override function SetAllocatorFunctions().
...
//  The default imgui_lib styles will be impacted by this change (alpha values will need tweaking).
...
namespace {
    ...
    struct FreeTypeFont {
        ...
        void
        BlitGlyph(const FT_Bitmap *ft_bitmap, uint8_t *dst, uint32_t dst_pitch, unsigned char *multiply_table = NULL);
