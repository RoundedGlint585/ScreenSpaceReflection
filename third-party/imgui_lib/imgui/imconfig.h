...
// the imgui_lib*.cpp files but also _any_ of your code that uses Dear ImGui. This is because some compile-time options have an affect on data structures.
// Defining those options in imconfig.h will ensure every compilation unit gets to see the same data structure layouts.
// Call IMGUI_CHECKVERSION() from your .cpp files to verify that the data structures your files are using are matching the ones imgui_lib.cpp is using.
//-----------------------------------------------------------------------------
...
//---- Include imgui_user.h at the end of imgui_lib.h as a convenience
...
// By default the embedded implementations are declared static and not available outside of imgui_lib cpp files.
